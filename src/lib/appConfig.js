...
export const clock = {icon: '', component: Clock, text: '时钟', desc: '秒钟', url: '', bgColor: 'bg-white', color: 'text-black',injClass: '!pt-0 !pb-0 !px-1.5 transition-scale !bg-transparent !shadow-none'}
