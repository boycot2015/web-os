...
<Grid {row} {col}>
    <div
        role="none"
        class="relative flex flex-col {row == 3 ?'h-[10rem]': 'h-[3.8rem] mx-1.5'} {injClass} flex-col justify-center dark:bg-black rounded-xl text-xs text-center shadow dark:shadow-white/10"
    >
        <div>{weekDay}</div>
